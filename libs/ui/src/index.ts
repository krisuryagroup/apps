...
export * from './components/truncated-text/truncated-text.component';
...
export * from './components/zoomable-image/zoomable-image.component';
export * from './components/zoomable-image/zoomable-image-examples.component';
