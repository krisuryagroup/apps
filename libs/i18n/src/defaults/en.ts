export const EN_DEFAULTS = {
  ...
  restaurant: {
    menu: 'Menu', addItem: 'Add Item', addCategory: 'Add Category', categories: 'Categories',
    allItems: 'All Items', noItems: 'No items found.', noOrders: 'No orders in this queue.',
    inventory: 'Inventory', staff: 'Staff', ratings: 'Ratings & Reviews', profile: 'Profile & Settings',
    onboarding: 'Account Setup', menuImport: 'Import Menu (AI)', addManually: 'Add Manually',
    aiImportDisabled: 'AI menu import is currently disabled. You can add items manually.',
    uploadMenuPhotos: 'Upload menu photos or PDF', parseMenu: 'Parse with AI',
    reviewParsedMenu: 'Review Parsed Menu', importAll: 'Import All',
    pendingOrders: 'Pending Orders', lowStockAlerts: 'Low Stock Alerts',
    viewPendingOrders: 'View Pending Orders', addMenuItem: 'Add Menu Item',
    rejectOrder: 'Reject Order', rejectReason: 'Reason for rejection',
    login: {
      phone: 'Phone number', password: 'Password', signIn: 'Sign in',
      noAccount: "Don't have an account?", apply: 'Apply to become a partner',
      errorInvalidCredentials: 'Invalid phone or password.',
      errorDeactivated: 'This account has been deactivated. Contact support.',
    },
    apply: {
      title: 'Become a Zitro Partner', subtitle: 'Grow your business with Zitro.',
      submit: 'Submit Application', successTitle: 'Application Received!',
    ...
    invite: {
      title: 'Set up your account', forBusiness: 'You were invited to manage',
      setPassword: 'Set Password', invalidToken: 'This invitation link is invalid or has expired.',
