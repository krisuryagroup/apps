export const EN_DEFAULTS = {
  ...
  businesses: {
    ...
    commissionNotAccepted: 'not accepted',
    coverPhoto: 'Cover Photo',
    featured: 'Featured',
    featuredHint: '(highlighted to customers in the Featured section)',
    ...
    payoutAccountIdHint: 'Enter after verifying the bank proof document',
    viewBankProof: 'View bank proof document',
    userName: 'Name',
    userPhone: 'Phone',
    userEmail: 'Email',
    userRole: 'Role',
  ...
  brands: {
    ...
    linkExisting: '+ Link Existing Business',
    linkExistingTitle: 'Link an existing business to {name}',
    searchBusinessPlaceholder: 'Search businesses by name or slug…',
    link: 'Link',
    noSearchResults: 'No matching businesses found.',
  ...
  products: {
    ...
    bulkPriceAdjust: 'Bulk Price Adjust',
    bulkScope: 'Apply to',
    bulkScopeBusiness: 'A business',
    bulkScopeBrand: 'A brand (master catalog)',
    bulkDirection: 'Direction',
    bulkIncrease: 'Increase',
    bulkDecrease: 'Decrease',
    bulkType: 'By',
    bulkPercentage: 'Percentage (%)',
    bulkFlatAmount: 'Flat amount (\u20b9)',
    bulkValue: 'Value',
    bulkValuePercentPlaceholder: 'e.g. 10 for 10%',
    bulkValueFlatPlaceholder: 'e.g. 20 for \u20b920',
    bulkApply: 'Apply to all matching products',
    bulkResult: '{count} product(s) updated.',
    bulkError: 'Could not apply the price adjustment. Please try again.',
    ...
    loadError: 'Could not load the product. Please try again.',
  },
  categories: {
    name: 'Name',
    path: 'Path',
  ...
  deliveryZones: {
    ...
    polygonDrawHint:
      'Click on the map to draw your delivery area — add at least 3 points, then click your first point again (or the Finish button) to close the shape.',
    polygonEditHint:
      'Drag any point to reshape the area, or use Clear to start over.',
    finishDrawing: 'Finish Drawing',
    clearAndRedraw: 'Clear & Redraw',
    boundaryRequired: 'Draw the zone boundary on the map before saving.',
  },
  payouts: {
  ...
  restaurant: {
    ...
    bulkOverrideHint:
      'This sets a price override for every item in the brand’s master menu, based on its current effective price (your existing override if you have one, otherwise the master price). It never changes the brand’s own prices — only what this branch charges.',
    bulkAdd: 'Bulk Add',
    bulkAddTitle: 'Bulk Add Menu Items',
    bulkAddHint:
      'Fill in rows like a spreadsheet — press Enter on the last row to add another. Pick an image per row if you have one, then Save All.',
    bulkAddSaveAll: 'Save All',
    bulkAddSaving: 'Saving…',
    bulkAddResult: '{saved} item(s) saved, {failed} failed.',
    bulkAddAllSaved: 'All items saved.',
    bulkAddNothingToSave: 'Add at least one item with a name before saving.',
    bulkAddColumnName: 'Name',
    bulkAddColumnPrice: 'Price',
    bulkAddColumnCategory: 'Category',
    bulkAddColumnFoodType: 'Food type',
    bulkAddColumnAvailable: 'Available',
    bulkAddColumnImage: 'Image',
    bulkAddImageError: 'Could not upload this image.',
    ...
    apply: {
      ...
      sendOtp: 'Send OTP',
      enterOtp: 'Enter the code we sent you',
