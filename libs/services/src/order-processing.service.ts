...
export class OrderProcessingService {
  ...
  private stages: Record<OrderProcessingStage['stage'], { message: string; progress: number }> = {
    ...
    confirming: { message: 'Confirming order with restaurant...', progress: 80 },
  ...
  async processStageWithDelay(stage: OrderProcessingStage['stage'], minDelay: number = 1000): Promise<void> {
