...
import { businessAuthGuard, guestOnlyGuard } from './core/guards/business-auth.guard';
...
import { RestaurantApplyComponent, RestaurantAcceptInviteComponent } from './features/onboarding/apply.component';
...
import {
  RestaurantStaffComponent, RestaurantInventoryComponent, RestaurantRatingsComponent,
  RestaurantPayoutsComponent, RestaurantDeliveryZonesComponent,
...
export const routes: Routes = [
  ...
  // ── Public / onboarding ──────────────────────────────────────────────────
  { path: 'login', canActivate: [guestOnlyGuard], component: RestaurantLoginComponent },
  { path: 'apply', canActivate: [guestOnlyGuard], component: RestaurantApplyComponent },
  { path: 'accept-invite', canActivate: [guestOnlyGuard], component: RestaurantAcceptInviteComponent },
