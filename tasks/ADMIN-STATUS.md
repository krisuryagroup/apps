...
| AD-001                  | Login                                                                                                       | S    | `[x]`  | done — shared `AdminLoginComponent` in `@zitro/admin-ui` (co-built with SA-001); email/password, distinct error states, all `data-testid` attrs |
| **Overview**            |                                                                                                             |      |        |                                                                                                                                                 |
| AD-002                  | Dashboard                                                                                                   | M    | `[x]`  | done — StatCard grid, GET /api/admin/dashboard, all fields live                                                                                 |
| **Business Management** |                                                                                                             |      |        |                                                                                                                                                 |
| AD-003                  | Businesses — List/Search + Invite Partner                                                                   | M    | `[x]`  | done — list+filters+invite-partner form; needs manual SQL + EMAIL_API_KEY for invite emails                                                     |
| AD-004                  | Business Detail + Approve/Reject Onboarding                                                                 | L    | `[x]`  | done — profile/KYC fields, approve/reject with reason picker                                                                                    |
| AD-005                  | Business — Edit                                                                                             | M    | `[x]`  | done — edit form with commission + featured toggle                                                                                              |
| AD-006                  | Brands Management                                                                                           | M    | `[x]`  | done — CRUD list with create/edit panel                                                                                                         |
| AD-007                  | Tags Management                                                                                             | S    | `[x]`  | done — CRUD with priority, deactivate                                                                                                           |
| **Catalog**             |                                                                                                             |      |        |                                                                                                                                                 |
| AD-008                  | Products — Global Catalog                                                                                   | L    | `[x]`  | done — search + delete; create/edit form to be added with media upload in follow-up                                                             |
| AD-009                  | Categories — Global                                                                                         | M    | `[x]`  | done — tree list, create with parent selector                                                                                                   |
| **Orders & Users**      |                                                                                                             |      |        |                                                                                                                                                 |
| AD-010                  | Order Oversight / Cross-Business Search                                                                     | M    | `[x]`  | done — search by phone, order ID, status, date range                                                                                            |
| AD-011                  | Users — List/Detail/Block                                                                                   | M    | `[x]`  | done — list with block/unblock                                                                                                                  |
| **Commercial**          |                                                                                                             |      |        |                                                                                                                                                 |
| AD-012                  | Coupons Management                                                                                          | M    | `[x]`  | done — CRUD list                                                                                                                                |
| AD-013                  | Cashback Rules                                                                                              | M    | `[x]`  | done (placeholder) — TASK-018 Wallet backend pending                                                                                            |
| AD-014                  | Delivery Partners Management                                                                                | M    | `[x]`  | done — list with suspend/activate                                                                                                               |
| AD-015                  | Delivery Zones — Global Admin                                                                               | S    | `[x]`  | done — list + create form                                                                                                                       |
| AD-016                  | Payouts — Generate/Mark Paid                                                                                | M    | `[x]`  | done — generate payouts by date range                                                                                                           |
| AD-017                  | Subscription Plans                                                                                          | M    | `[x]`  | done (placeholder) — TASK-021 Subscriptions backend pending                                                                                     |
| AD-018                  | Banners Management                                                                                          | M    | `[x]`  | done — CRUD list, create/delete                                                                                                                 |
| **Admin Ops**           |                                                                                                             |      |        |                                                                                                                                                 |
| AD-019                  | Admin Users Management (SuperAdmin-gated)                                                                   | M    | `[x]`  | done — list with create + activate/deactivate; SuperAdmin-gated by permission                                                                   |
| **Platform**            |                                                                                                             |      |        |                                                                                                                                                 |
