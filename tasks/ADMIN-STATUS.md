...
| **Business Management** |                                                                                                             |      |        |                                                                                                                                                 |
| AD-003                  | Businesses — List/Search + Invite Partner                                                                   | M    | `[ ]`  | ready — zitro-api TASK-039 done (needs manual SQL + EMAIL_API_KEY, see zitro-api/TASK-STATUS.md)                                                |
| AD-004                  | Business Detail + Approve/Reject Onboarding                                                                 | L    | `[ ]`  | ready — zitro-api TASK-032 done                                                                                                                 |
| AD-005                  | Business — Edit                                                                                             | M    | `[ ]`  | ready — zitro-api TASK-032 done                                                                                                                 |
...
| **Orders & Users**      |                                                                                                             |      |        |                                                                                                                                                 |
| AD-010                  | Order Oversight / Cross-Business Search                                                                     | M    | `[ ]`  | ready — zitro-api TASK-035 done                                                                                                                 |
...
| AD-018                  | Banners Management                                                                                          | M    | `[ ]`  | ready — list/delete already existed, no backend gap (see zitro-api TASK-037)                                                                    |
| **Admin Ops**           |                                                                                                             |      |        |                                                                                                                                                 |
